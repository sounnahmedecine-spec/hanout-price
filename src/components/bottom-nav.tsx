...
export default function BottomNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-background/80 backdrop-blur-sm border-t border-border z-40">
      <div className="grid grid-cols-5 items-center h-full">
        ...
        <div className="flex justify-center items-center">
            <Button asChild size="icon" className="w-16 h-16 rounded-full -translate-y-4 shadow-lg bg-primary hover:bg-primary/90">
